...
INSERT INTO `ims`.`customers` (`first_name`, `last_name`) VALUES ('peter', 'parker');
INSERT INTO `ims`.`customers` (`first_name`, `last_name`) VALUES ('mary', 'jane');
INSERT INTO `ims`.`customers` (`first_name`, `last_name`) VALUES ('miles', 'morales');

INSERT INTO `ims`.`items` (`name`, `price`) VALUES ('Spider-Man: Miles Morales', 40);
